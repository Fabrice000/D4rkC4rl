...
![search](img/currency1.png)

and select the BTC Account and we got our result

![searching](img/currency11.png)
...
![openpgp](img/proton.png)

![openpgp key](img/proton1.png)
